...
const NormalMarkdownPage:React.FC<BlogContentEntity> = (props)=>{
    return <div style={{backgroundColor:"#edf2f7"}}>
        ...
        <VStack>
            <HStack alignItems="start" maxW={1120}>
                <Stack>
                    <Box color="#2e2e2e" w={"full"} maxW={"700px"} bg="white" boxShadow="0 2px 4px #4385bb12" borderRadius={12} p={10}>
                ...
                <Box maxW={"340px"} top="38px" position="sticky" display={{base:"none",xl:"block"}} pl={5}>
            ...
            <HStack pt={5} w={"full"} maxW={750} display={{base:"block",xl:"none"}}>
                <AuthorCard author={props.author}/>
            </HStack>
            <HStack w={"full"} h={10}/>
        </VStack>
